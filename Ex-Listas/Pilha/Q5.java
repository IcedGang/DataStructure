...
public class Q5 {
    public static void main(String[] args) {
        ...
        for(int i = 0; i < str.length(); i++){
            insertRemove(stack1, str, '(', ')', i);
            insertRemove(stack2, str, '[', ']', i);
            insertRemove(stack3, str, '{', '}', i);
        }
    ...
    // Insere e retira o caractere da pilha
    public static void insertRemove(Pilha<Character> stack, String str, Character open, Character close, int i){
